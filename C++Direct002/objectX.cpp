...
void CObjectX::Update(void)
{
	...
	bool bLand = false;
	float fHeight = CScene::GetElevationOutside(CElevation::POSTYPE_UP)->GetHeight(pos, D3DXVECTOR3(0.0f, 0.0f, 0.0f), bLand, GetType());
	if (bLand == true)
	{
		pos.y = fHeight;
	}
	...
	bLand = false;
	fHeight = CScene::GetElevationOutside(CElevation::POSTYPE_RIGHT)->GetHeight(pos, D3DXVECTOR3(0.0f, 0.0f, 0.0f), bLand, GetType());
	if (bLand == true)
	{
		pos.y = fHeight;
	}
	...
	bLand = false;
	fHeight = CScene::GetElevationOutside(CElevation::POSTYPE_DOWN)->GetHeight(pos, D3DXVECTOR3(0.0f, 0.0f, 0.0f), bLand, GetType());
	if (bLand == true)
	{
		pos.y = fHeight;
	}
	...
	bLand = false;
	fHeight = CScene::GetElevationOutside(CElevation::POSTYPE_LEFT)->GetHeight(pos, D3DXVECTOR3(0.0f, 0.0f, 0.0f), bLand, GetType());
	if (bLand == true)
	{
		pos.y = fHeight;
	}
